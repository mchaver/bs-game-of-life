...
function resetGrid(rows, columns, _) {
  Random.self_init(/* () */0);
...
var random_button = document.getElementById("random-reset-button");

if (random_button !== null) {
  random_button.addEventListener("click", (function () {
          resetGrid(state[0][/* rows */2], state[0][/* columns */3], /* () */0);
          var init = state[0];
          state[0] = /* record */[
            /* run */false,
            /* grid */init[/* grid */1],
