...
var match$2 = document.getElementById("step-button");

var step_button = match$2 !== null ? match$2 : Pervasives.failwith("Cannot find the step-button");

var match$3 = document.getElementById("random-reset-button");

var random_reset_button = match$3 !== null ? match$3 : Pervasives.failwith("Cannot find the random-reset-button");

var match$4 = document.getElementById("speed-select");

var speed_select = match$4 !== null ? match$4 : Pervasives.failwith("Cannot find the speed-select");

canvas.addEventListener("click", (function (e) {
        var e$1 = e;
        var match = relMouseCoords(canvas, e$1);
        var o = calcIndex(match[0], match[1], state[0][/* rows */2], state[0][/* columns */3]);
        if (o) {
          var match$1 = o[0];
          var y = match$1[1];
          var x = match$1[0];
          var g = state[0][/* grid */1];
          var c = Caml_array.caml_array_get(Caml_array.caml_array_get(g, x), y);
          var newC = c ? /* Dead */0 : /* Alive */1;
          Caml_array.caml_array_set(Caml_array.caml_array_get(g, x), y, newC);
          var init = state[0];
          state[0] = /* record */[
            /* run */init[/* run */0],
            /* grid */g,
